...
const appHead = {"meta":[{"name":"description","content":"yosong blog site."},{"name":"author","content":"yosong"},{"name":"viewport","content":"width=device-width, initial-scale=1.0"},{"name":"revisit-after","content":"7 days"},{"name":"msapplication-TileColor","content":"#ffffff"},{"charset":"UTF-8"},{"http-equiv":"X-UA-Compatible","content":"IE=edge"}],"link":[{"rel":"icon","type":"image/x-icon","href":"/about/yosong.png"}],"style":[],"script":[],"noscript":[{"children":"JavaScript is required"}],"title":"yosong"};

const appRootTag = "div";

const appRootAttrs = {"id":"yosong-blog"};
