...
import { e as useNuxtApp, f as asyncDataDefaults, g as createError, c as useRuntimeConfig, l as withLeadingSlash, j as joinURL, b as withoutTrailingSlash, i as withBase, k as useRequestEvent, d as hash } from './server.mjs';
...
const createQueryFetch = () => async (query) => {
  ...
  if (shouldUseClientDB()) {
    const db = await import('./client-db-CkDghvs7.mjs').then((m) => m.useContentDatabase());
...
//# sourceMappingURL=query-DOwnc_F2.mjs.map
